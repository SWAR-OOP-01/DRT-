...
export const therapies: Therapy[] = [
  ...
  },
  {
    ...
    details: {
      why: 'Stress, poor sleep, mental overload, and physical inactivity can keep the body in a constant state of tension . PSR therapy helps activate relaxation response and improve circulation throughout the body .',
  ...
  },
  {
    code: 'RCN',
    name: 'RCN Therapy',
    tagline: 'Re Connect to Nature Therapy',
    ...
    details: {
      why: 'Modern life keeps people constantly connected to screens, deadlines, noise, and stress, creating physical tension and mental fatigue. This is not a luxury getaway. It is a guided 20-Hour therapeutic reset designed to help people leave feeling calmer, lighter, physically refreshed, mentally clearer, and more connected to themselves through nature, therapeutic bodywork, breath work, mindful practices, and deep rest.',
  ...
  },
  {
    ...
    details: {
      why: 'Pain Management Therapy focuses directly on easing persistent muscle knots, joint restrictions, and structural strain. Through advanced manual techniques, it intercepts baseline pain signals and reverses the impacts of recurring body fatigue to re-establish long-term functional balance .',
