    ...
    <SiteShell>
      ...
      <section className="bg-background border-t border-gold/5 pt-6 pb-12 overflow-hidden">
        <div className="mx-auto max-w-7xl w-full px-6 lg:px-12">
          {/* Locked height layout wrapper blueprints to build pure split frames */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:h-[620px] items-stretch">
            {/* Left Column Box: Hard Fixed 50% Image Container Frame */}
            ...
            <div className="w-full h-full flex flex-col justify-between overflow-hidden">
              {/* Isolated Scrollable Text Flow Blocks Panel */}
              <div className="flex-1 overflow-y-auto pr-4 space-y-4 custom-scrollbar mb-6">
                <div
                  className={`${newYorkSerif.className} text-xl sm:text-2xl font-light tracking-wide text-slate-900`}
                >
                  <ExpandBlock index={1} title="Why This Therapy Is Vital">
                    <p
                      className={`${nexaExtraLight.className} font-normal text-base sm:text-lg leading-relaxed text-slate-800 whitespace-pre-line mt-3`}
                    >
                      Environmental toxins, environmental pollution, processed
                      food ingestion, chronic psychological stress, and physical
                      stagnation introduce metabolic load over baseline
                      physiology. When the liver, kidneys, and digestive
                      channels get overloaded, waste accumulates.
                      {"\n\n"}
                ...
                >
                  <ExpandBlock index={3} title="Benefits Matrix">
                    ...
                    <p
                      className={`${nexaExtraLight.className} font-normal mt-5 text-[10px] italic text-muted-ink/60 leading-normal`}
                    >
                      Note: This therapy is intended strictly to support natural
                      wellness processes. DRT wellness services are not meant to
                      diagnose, clinically treat, or substitute medical
                      prescriptions.
                    </p>
                  </ExpandBlock>
                </div>
              ...
              {/* ✅ UPDATED: Path configured to append standard query parameters targeting LKC Therapy options dynamically */}
